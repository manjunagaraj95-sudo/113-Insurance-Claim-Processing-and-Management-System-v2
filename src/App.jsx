        ...
        <div className="main-content">
            <div className="dashboard-section-header">
                ...
                <div className="flex-row gap-md">
                    ...
                    {/* Added 'New Claim' button here as a top-level action */}
                    {permissions.canSubmitClaim && (
                        <Button variant="primary" icon="icon-file" onClick={() => navigateTo('SUBMIT_CLAIM')}>New Claim</Button>
                    )}
                </div>
            </div>
            ...
            <div className="dashboard-section-header">
                ...
                {/* Removed the 'Submit New Claim' button from here, moved to top header */}
            </div>
